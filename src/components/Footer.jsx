    ...
    <footer className="bg-white border-t border-gray-100">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 text-[#0B3B6E] font-extrabold text-lg mb-4">
            ...
            <div className="flex gap-3">
              <a href="#" className="bg-gray-100 rounded-lg p-2 text-gray-500 hover:bg-[#0B3B6E] hover:text-white transition-colors" aria-label="Facebook">
                <FacebookIcon />
              </a>
              <a href="#" className="bg-gray-100 rounded-lg p-2 text-gray-500 hover:bg-[#0B3B6E] hover:text-white transition-colors" aria-label="Twitter">
                <TwitterIcon />
              </a>
              <a href="#" className="bg-gray-100 rounded-lg p-2 text-gray-500 hover:bg-[#0B3B6E] hover:text-white transition-colors" aria-label="LinkedIn">
                <LinkedinIcon />
              </a>
            </div>
          </div>
          ...
          {footerData.map((col) => (
            <div key={col.title}>
              ...
              <ul className="space-y-2.5">
                {col.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-sm text-gray-500 hover:text-[#0B3B6E] transition-colors">{link}</a>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <div className="border-t border-gray-100 py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1280px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-gray-400">&copy; 2026 MedTrust Africa. All rights reserved.</p>
