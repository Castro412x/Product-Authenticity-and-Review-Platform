...
import { ShieldCheck, Mail, Shield, CheckCircle, Lock, AlertCircle } from 'lucide-react'
      ...
      <div className="flex max-w-[1200px] w-full rounded-2xl shadow-2xl dark:shadow-gray-900/50 overflow-hidden min-h-[600px]">
        ...
        <div className="w-full md:w-1/2 bg-white dark:bg-gray-900 p-8 lg:p-12 flex flex-col justify-center">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-2 w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-lg py-2.5 px-4 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 transition-colors duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
          >
